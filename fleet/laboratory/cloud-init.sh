...
apt-get update -qq
apt-get install -y -qq ca-certificates curl git jq python3 python3-venv tmux unzip build-essential
...
DASHBOARD_REPO=MountDiabloAdvisors/dashboard
DASHBOARD_DIR=/home/ubuntu/mda-dashboard
DASHBOARD_HOST=127.0.0.1
DASHBOARD_PORT=8700
DASHBOARD_DB_PATH=/home/ubuntu/mda-dashboard-data/dashboard.db
DASHBOARD_DATABASE_URL=${DASHBOARD_DATABASE_URL}
DASHBOARD_SCHWAB_APP_KEY=${DASHBOARD_SCHWAB_APP_KEY}
DASHBOARD_SCHWAB_APP_SECRET=${DASHBOARD_SCHWAB_APP_SECRET}
DASHBOARD_SCHWAB_MARKET_APP_KEY=${DASHBOARD_SCHWAB_MARKET_APP_KEY}
DASHBOARD_SCHWAB_MARKET_APP_SECRET=${DASHBOARD_SCHWAB_MARKET_APP_SECRET}
DASHBOARD_PLAID_CLIENT_ID=${DASHBOARD_PLAID_CLIENT_ID}
DASHBOARD_PLAID_SECRET=${DASHBOARD_PLAID_SECRET}
DASHBOARD_PLAID_ENV=${DASHBOARD_PLAID_ENV}
DASHBOARD_COINGECKO_API_KEY=${DASHBOARD_COINGECKO_API_KEY}
ENVEOF
